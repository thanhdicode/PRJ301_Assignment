<%-- 
    Document   : contact
    Created on : Jun 20, 2024, 10:24:49 AM
    Author     : ADMIN
--%>
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li class="active"><a href="DispatchServlet?btnAction=Contact">Contacts</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3 col-md-3">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__text">
                        ...
                        <ul>
                            <li>
                                <h4>Viet Nam</h4>
                                <p>Truong dai hoc FPT HCM<br />027299988877</p>
                            </li>
                            <li>
                                <h4>France</h4>
                                <p>109 Avenue Léon, 63 Clermont-Ferrand <br />090909888111</p>
                            </li>
                        </ul>
                    </div>
                </div>
