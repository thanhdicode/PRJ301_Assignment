<%-- 
    Document   : about
    Created on : Jun 20, 2024, 10:18:09 AM
    Author     : ADMIN
--%>
            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="testimonial__text">
                        ...
                        <p>“Thật là 1 trải nghiệm tuyệt vời của Tùng tại Shop của Nhật Thành.
                            Cảm ơn rất nhiều shop đã tài trợ cho MV Đừng làm trái tim anh đau của tôi.”
                        </p>
                        <div class="testimonial__author">
                            <div class="testimonial__author__pic">
                                <img src="img/hero/sontung.jpg" alt="">
                            </div>
     ...
     <section class="testimonial">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 p-0">
                    <div class="testimonial__pic set-bg" data-setbg="img/about/ao-dau-MU.jpg"></div>
                </div>
                 <div class="col-lg-6 p-0">
                    <div class="testimonial__text">
                        <span class="icon_quotations"></span>
                        <p>“SIUUUUUUUUUUUUU!!!! 
                            Cảm ơn shop Nhật Thành đã hợp tác cho ra áo đấu của tôi và trở thành sản phẩm best-seller”
                        </p>
                        <div class="testimonial__author">
                            <div class="testimonial__author__pic">
                                <img src="img/cauthu/CR7.jpg" alt="">
                            </div>
                            <div class="testimonial__author__text">
