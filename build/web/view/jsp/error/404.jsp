<%-- 
    Document   : 404_1
    Created on : Jun 22, 2024, 4:57:14 PM
    Author     : ADMIN
--%>
...
$(function () {
    ...
    <div id="main-content">
      ...
      <div id="navigation">
        <a class="navigation" href="index">Home</a><a class="navigation" href="DispatchServlet?btnAction=aboutus">About
        Us</a>
        <a class="navigation" href="home">Site Map</a>
        <a class="navigation" href=
        "DispatchServlet?btnAction=Contact">Contact</a>
      </div>
    </div>
  </div>
    </body>
