        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>List of Categories</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
        ...
        <script type="text/javascript">
                                                    function confirmDelete(modalID, cid) {
                                                        ...
                                                        let modal = '<div class="modal-dialog modal-dialog-centered" role="document" style="text-align:center">' +
                                                                ...
                                                                '<button data-dismiss="modal" aria-hidden="true" class="swal-button swal-button--cancel">Cancel</button>' +
                                                                '</div>' +
                                                                '<div class="swal-button-container">' +
